...
\pdfoutput=1
\usepackage{amsmath,amssymb,gensymb,color,graphicx,array,authblk,multirow,soul}
...
\definecolor{purple}{rgb}{0.7,0.0,0.5}
\lstset{
	language=Python,
...
\begin{figure}[ph!]
	...
	\\
		...
		\img{examples/src_gain_2d_corr_pgls_map_0.png} &
		\img{examples/src_gain_2d_corr_xgls_map_0.png} &
	...
	\\
		...
		\img{examples/src_ptoff_2d_corr_pgls_map_0.png} &
		\img{examples/src_ptoff_2d_corr_xgls_map_0.png} &
	...
	\\
		...
		\img{examples/src_noise_2d_corr_pgls_map_0.png} &
		\img{examples/src_noise_2d_corr_xgls_map_0.png} &
	...
	\\
		...
		\img{examples/src_noise_gain_2d_corr_pgls_map_0.png} &
		\img{examples/src_noise_gain_2d_corr_xgls_map_0.png} &
	...
	\\
		...
		\img{examples/src_noise_ptoff_2d_corr_pgls_map_0.png} &
		\img{examples/src_noise_ptoff_2d_corr_xgls_map_0.png} &
	...
	\\
		...
		\img{examples/src_cmb_noise_2d_corr_pgls_map_0.png} &
		\img{examples/src_cmb_noise_2d_corr_xgls_map_0.png} &
	...
	\\
		...
		\img{examples/src_cmb_noise_gain_2d_corr_pgls_map_0.png} &
		\img{examples/src_cmb_noise_gain_2d_corr_xgls_map_0.png} &
...
\begin{table}
	...
	\caption{The maximum absolute value of the leakage from a point source
		...
		and \dfn{far}: beyond 10 pixels from the center. The leakage is measured as the
		difference between a map using the given model and a correlated noise model and a map using
		standard nearest neighbor with a white noise model. For the beam, pixel size and noise model
...
\begin{figure}[ph!]
	...
	\begin{tabular}{>{\centering\arraybackslash}m{15mm}>{\centering\arraybackslash}m{12mm}>{\centering\arraybackslash}m{12mm}>{\centering\arraybackslash}m{12mm}>{\centering\arraybackslash}m{12mm}>{\centering\arraybackslash}m{12mm}>{\centering\arraybackslash}m{12mm}>{\centering\arraybackslash}m{12mm}>{\centering\arraybackslash}m{12mm}>{\centering\arraybackslash}m{12mm}>{\centering\arraybackslash}m{12mm}>{\centering\arraybackslash}m{12mm}>{\centering\arraybackslash}m{12mm}}
		...
		\\
			...
			\img{examples/cmb_2d_corr_pgls_map_0.png} &
			\img{examples/cmb_2d_corr_xgls_map_0.png} &
		...
		\\
			...
			\img{examples/cmb_gain_2d_corr_pgls_map_0.png} &
			\img{examples/cmb_gain_2d_corr_xgls_map_0.png} &
		...
		\\
			...
			\img{examples/cmb_ptoff_2d_corr_pgls_map_0.png} &
			\img{examples/cmb_ptoff_2d_corr_xgls_map_0.png} &
		...
		\\
			...
			\img{examples/cmb_2d_corr_pgls_map_1.png} &
			\img{examples/cmb_2d_corr_xgls_map_1.png} &
		...
		\\
			...
			\img{examples/cmb_gain_2d_corr_pgls_map_1.png} &
			\img{examples/cmb_gain_2d_corr_xgls_map_1.png} &
		...
		\\
			...
			\img{examples/cmb_ptoff_2d_corr_pgls_map_1.png} &
			\img{examples/cmb_ptoff_2d_corr_xgls_map_1.png} &
		...
		\\
			...
			\img{examples/cmb_2d_corr_pgls_map_2.png} &
			\img{examples/cmb_2d_corr_xgls_map_2.png} &
		...
		\\
			...
			\img{examples/cmb_gain_2d_corr_pgls_map_2.png} &
			\img{examples/cmb_gain_2d_corr_xgls_map_2.png} &
		...
		\\
			...
			\img{examples/cmb_ptoff_2d_corr_pgls_map_2.png} &
			\img{examples/cmb_ptoff_2d_corr_xgls_map_2.png} &
...
\begin{table}
	...
	\caption{The standard deviation of the difference between a map made with a correlated
		...
		only happen near the targeted sources. Unlike table~\ref{tab:srcleak} the same mapmaking method
		is used for the maps being subtracted, to avoid penalizing methods with different pixel windows.}
	\label{tab:cmbleak}
\end{table}
